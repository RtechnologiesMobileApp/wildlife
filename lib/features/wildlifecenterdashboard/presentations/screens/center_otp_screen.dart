...
class CenterOtpScreen extends StatefulWidget {
  final String email;

  const CenterOtpScreen({super.key, required this.email});

  @override
  State<CenterOtpScreen> createState() => _CenterOtpScreenState();
}

class _CenterOtpScreenState extends State<CenterOtpScreen> {
  ...
  void _verifyOtp() async {
    ...
    // For prototype, navigate to center dashboard
    if (mounted) {
      Get.offAll(() => const CenterDashboardScreen());
      ScaffoldMessenger.of(context).showSnackBar(
